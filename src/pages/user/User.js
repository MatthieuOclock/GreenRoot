    ...
    const fetchUserData = async () => {
      try {
        ...
        const userResponse = await fetch(
          `${process.env.URL_API}user/test/test`,
          {
            headers: {
        ...
        const treesResponse = await fetch(
          `${process.env.URL_API}user/me/trees`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
        ...
        const ordersResponse = await fetch(
          `${process.env.URL_API}order/me/trees`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
          ...
          <div className="profilForm">
            ...
            {isEditing.last_name ? (
              <>
                ...
                <button
                  type="button"
                  onClick={(e) => handleUpdate(e, "last_name")}
                >
                  Enregistrer
                </button>
              </>
          ...
          <div className="profilForm">
            ...
            {isEditing.first_name ? (
              <>
                ...
                <button
                  type="button"
                  onClick={(e) => handleUpdate(e, "first_name")}
                >
                  Enregistrer
                </button>
              </>
            ...
            {isEditing.email ? (
              <>
                <input
                  ...
                  onChange={handleInputChange}
                />
                <button type="button" onClick={(e) => handleUpdate(e, "email")}>
                  Enregistrer
                </button>
              </>
            ) : (
            ...
            {isEditing.phone ? (
              <>
                <input
                  ...
                  onChange={handleInputChange}
                />
                <button type="button" onClick={(e) => handleUpdate(e, "phone")}>
                  Enregistrer
                </button>
              </>
            ) : (
